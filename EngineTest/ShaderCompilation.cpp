...
using namespace spoon::graphics::d3d12::shaders;
...
namespace {
	...
	public:
		...
		dxc_compiled_shader compile(shader_file_info info, std::filesystem::path full_path, spoon::utl::vector<std::wstring>& extra_args)
		{
		...
		dxc_compiled_shader compile(IDxcBlobEncoding* source_blob, spoon::utl::vector<std::wstring> compiler_args)
		{
			DxcBuffer buffer{};
